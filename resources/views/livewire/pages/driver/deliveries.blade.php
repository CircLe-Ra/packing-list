...
<div>
    ...
    <div>
        ...
        @if ($this->deliveries && $this->deliveries->isNotEmpty())
            <div
                class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-2 mb-10 @if (count($this->deliveries) <= 2) place-items-center @endif">
